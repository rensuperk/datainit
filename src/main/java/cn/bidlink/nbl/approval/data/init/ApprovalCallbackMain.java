...
public class ApprovalCallbackMain {
    public static void main(String[] args) {
        ...
        TemplateApprovalInstance templateApprovalInstance = templateDao.query(TemplateApprovalInstance.class, Cnd.where("PROCESS_ID", "=", 15370832).orderBy("CREATE_TIME", "desc"), new Pager(1, 1)).get(0);
